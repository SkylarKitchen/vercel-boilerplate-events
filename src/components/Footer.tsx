...
const socialLinks = [
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/anthropicresearch",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "YouTube",
    href: "https://youtube.com/@anthropic-ai",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/anthropicai",
    icon: (
      <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default function Footer() {
  return (
    <footer className="bg-bg-inverse">
      <div className="max-w-7xl mx-auto px-site py-section-sm">
        <div className="flex flex-col lg:flex-row lg:justify-between gap-16">
          ...
          <div className="flex flex-col justify-between">
            ...
            {/* Attribution + social */}
            <div className="mt-16">
              <p className="text-xs uppercase tracking-[0.2em] text-fg-inverse/50 font-medium">
                By Anthropic
              </p>
              <p className="mt-1.5 text-xs text-fg-inverse/35">
              ...
              <div className="flex items-center gap-5 mt-5">
                {socialLinks.map((social) => (
                  <Link
                    ...
                    className="text-fg-inverse/50 hover:text-fg-inverse transition-colors"
                  >
                    {social.icon}
                  </Link>
                ))}
          ...
          <div>
            <h3 className="text-sm text-fg-inverse/50 mb-4">
              Terms and Policies
            </h3>
