 ...
 * Typography-dominant editorial layout. A massive "w/ Claude" serif headline
 * spans the full viewport width as the central visual element. Below, a
 * two-column layout pairs the event pitch with a location/date table.
...
export default function Hero22() {
  return (
    <main className="relative min-h-screen bg-bg-primary flex flex-col pt-20">
      ...
      <div className="flex-1 flex flex-col justify-end px-site pb-10 lg:pb-14">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          ...
          >
            <h3
              className="font-serif text-fg-primary leading-[1.1] tracking-[-0.01em]"
